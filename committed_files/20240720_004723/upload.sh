...
git pull --rebase https://github.com/aflahmod123/Cinnamon-.git master

if [ $? -eq 0 ]; then
    # Successfully rebased, now push
    git push https://github.com/aflahmod123/Cinnamon-.git master
